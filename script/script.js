...
function handleTabletChange(e) {
    ...
    // перемещения блока weekly-bonus
    transferBlockBonuc();
	}
}
...
// перенос блока weekly-bonus на мобильной версии
function transferBlockBonuc(){
  const weeklyBonus = document.querySelector(".weekly-bonus-block");
  const contentInsert = document.querySelector(".brands-block");
